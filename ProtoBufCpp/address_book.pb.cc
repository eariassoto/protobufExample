...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_address_5fbook_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Person_PhoneNumber;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_address_5fbook_2eproto ::google::protobuf::internal::SCCInfo<2> scc_info_Person;
}  // namespace protobuf_address_5fbook_2eproto
...
::google::protobuf::internal::SCCInfo<2> scc_info_Person =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsPerson}, {
      &protobuf_address_5fbook_2eproto::scc_info_Person_PhoneNumber.base,
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "address_book.proto", schemas, file_default_instances, TableStruct::offsets,
...
const ::google::protobuf::EnumDescriptor* Person_PhoneType_descriptor() {
  ...
  return protobuf_address_5fbook_2eproto::file_level_enum_descriptors[0];
}
...
const Person_PhoneNumber& Person_PhoneNumber::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_address_5fbook_2eproto::scc_info_Person_PhoneNumber.base);
...
AddressBook::AddressBook()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_address_5fbook_2eproto::scc_info_AddressBook.base);
  SharedCtor();
